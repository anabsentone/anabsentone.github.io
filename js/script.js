...
var workLibrary = {
    ...
    "districtsix": {
        ...
        "implement": {
            0: {
                "txt": "Particular <span class='keyword'>interaction features</span> were programmed to support exploration of the large quantity of content contained within the map:</ul><ul>togglable layers allowed focusing on particular content such as individual resident’s stories or groups of community landmarks by graphically highlighting the selected layer’s points of interest and gently fading the rest</ul><ul>image slideshows enabled scrolling through photos taken over the course of each resident’s life without overcrowding the screen</ul><ul>an image overlay would cover the screen upon clicking any individual image, making the historical photos larger for better viewing as well as displaying accompanying textual descriptions about their significance</ul><ul>audio players lent an additional dimension of immersion through recordings of residents discussing life in District Six in their own voices</ul><ul>",
                "img": "",
                "alt": "",
            },
            1: {
